...
DATASETS_CONFIG = {
        ...
        'rice': {
            'urls': ['http://www.ehu.es/ccwintco/uploads/7/72/rice.mat',
                     'http://www.ehu.es/ccwintco/uploads/5/58/rice_label.mat'],
            'img': 'rice.mat',
            'gt': 'rice_label.mat'
            },
        'Fish': {
            'urls': ['http://www.ehu.es/ccwintco/uploads/7/72/去趋势.mat',
                     'http://www.ehu.es/ccwintco/uploads/5/58/label.mat'],
            'img': '去趋势.mat',
            'gt': 'label.mat'
        }
...
def get_dataset(dataset_name, target_folder="./", datasets=DATASETS_CONFIG):
    ...
    if dataset_name == 'PaviaC':
        ...
        # Load the image
        img = open_file(folder + 'rice.mat')['rice']

        rgb_bands = (70, 53, 19)  # AVIRIS sensor

        gt = open_file(folder + 'rice_label.mat')['rice_label']
        label_values = ['Undefined', 'rice1', 'rice2', 'rice3', 'rice4']

        ignored_labels = [0]

    elif dataset_name == 'Fish':
        img = open_file(folder + '去趋势.mat')['data']
        # Load the image

        rgb_bands = (96, 64, 30)  # AVIRIS sensor

        gt = open_file(folder + 'label.mat')['label']
        label_values = ['Undefined', 'day1', 'day2', 'day3', 'day4', 'day5', 'day6', 'day7']
